...
/***/ function(module, exports, __webpack_require__) {
	...
	var _leagueType = __webpack_require__(167);

	var _leagueType2 = _interopRequireDefault(_leagueType);

	var _leagueList = __webpack_require__(168);
	...
	var LeagueMain = function (_React$Component) {
	    _inherits(LeagueMain, _React$Component);

	    function LeagueMain() {
	        _classCallCheck(this, LeagueMain);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(LeagueMain).call(this));

	        console.log("init");
	        _this.state = { tier: DEFAULT_TIER, leagueList: null };
	        return _this;
	    }

	    _createClass(LeagueMain, [{
	        ...
	        key: 'changeType',
	        value: function changeType(tier) {
	            var self = this;
	            _jquery2.default.post("/league/list", { tier: tier }, function (result) {
	                if (result.code != 0) {
	                    console.log("error....");
	                    return;
	                }
	        ...
	        key: 'leagueTypeClick',
	        value: function leagueTypeClick(tier) {
	            console.log(tier);
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'league' },
	                _react2.default.createElement(_leagueType2.default, { clickHandler: this.leagueTypeClick.bind(this), tier: this.state.tier }),
	                _react2.default.createElement(_leagueList2.default, { leagueList: this.state.leagueList })
	            );
	        }
	    }]);
	...
	_reactDom2.default.render(_react2.default.createElement(LeagueMain, null), root);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LeagueType = function (_React$Component) {
	    _inherits(LeagueType, _React$Component);

	    function LeagueType() {
	        _classCallCheck(this, LeagueType);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(LeagueType).call(this));
	    }

	    _createClass(LeagueType, [{
	        key: "render",
	        value: function render() {
	            return _react2.default.createElement(
	                "ul",
	                ...
	                _react2.default.createElement(
	                    "li",
	                    { className: this.props.tier == 'premium' ? 'cur' : '', onClick: this.props.clickHandler.bind(null, "premium") },
	                    "高端组"
	                ),
	                _react2.default.createElement(
	                    "li",
	                    { className: this.props.tier == 'professional' ? 'cur' : '', onClick: this.props.clickHandler.bind(null, "professional") },
	                    "职业组"
	                ),
	                _react2.default.createElement(
	                    "li",
	                    { className: this.props.tier == 'amateur' ? 'cur' : '', onClick: this.props.clickHandler.bind(null, "amateur") },
	                    "业余组"
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _leagueEle = __webpack_require__(169);

	var _leagueEle2 = _interopRequireDefault(_leagueEle);
	...
	var LeagueList = function (_React$Component) {
	    ...
	    function LeagueList() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(LeagueList).call(this));
	    }
	    ...
	    _createClass(LeagueList, [{
	        ...
	        value: function render() {
	            ...
	            if (!leagueList) {
	                return _react2.default.createElement("ul", { className: "league-list" });
	            }
	            ...
	            return _react2.default.createElement(
	                ...
	                leagueList.map(function (item) {
	                    return _react2.default.createElement(_leagueEle2.default, _extends({ key: item.leagueid }, item));
	                })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LeagueEle = function (_React$Component) {
	    _inherits(LeagueEle, _React$Component);

	    function LeagueEle() {
	        _classCallCheck(this, LeagueEle);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(LeagueEle).call(this));
	    }

	    _createClass(LeagueEle, [{
	        key: "handlerClick",
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement("img", { src: this.props.image || DEFAULT_LEAGUE_ICON }),
	                _react2.default.createElement(
	                    "label",
	                    { className: this.props.free_to_spectate ? "league-with-tag" : "league-no-tag" },
	                    this.props.free_to_spectate ? "免费观看" : ""
	                ),
	                _react2.default.createElement(
	                    "h3",
	                    null,
	                ...
	                _react2.default.createElement(
	                    "label",
	                    { className: "league-money" },
	                    this.props.pricePool,
	                    "$"
	                ),
	                _react2.default.createElement(
	                    "span",

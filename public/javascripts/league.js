...
/***/ function(module, exports, __webpack_require__) {
	...
	var _leagueIntro = __webpack_require__(194);

	var _leagueIntro2 = _interopRequireDefault(_leagueIntro);

	var _matchList = __webpack_require__(195);
	...
	var League = function (_Component) {
	    ...
	    function League() {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(League).call(this));

	        var leagueid = _common2.default.getParaFromLocation("leagueid");
	        _this.state = { leagueInfo: null, matchList: null, leagueid: leagueid };
	        return _this;
	    }
	    ...
	    _createClass(League, [{
	        ...
	        key: 'initLeague',
	        value: function initLeague() {
	            var self = this;
	            _jquery2.default.get("/league/${this.state.leagueid}", function (result) {
	                if (result.code != 0) {
	                    //TODO error
	                } else {
	                        self.setState({});
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'matches' },
	                _react2.default.createElement(_leagueIntro2.default, this.state.leagueInfo),
	                _react2.default.createElement(_matchList2.default, { matchs: this.state.matchList })
	            );
	        }
	    }]);
	...
	_reactDom2.default.render(_react2.default.createElement(League, null), root);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LeagueIntro = function (_Component) {
	    _inherits(LeagueIntro, _Component);

	    function LeagueIntro() {
	        _classCallCheck(this, LeagueIntro);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(LeagueIntro).call(this));
	    }

	    _createClass(LeagueIntro, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'intro clear' },
	                _react2.default.createElement(
	                    'h3',
	                    { className: 'title' },
	                    _react2.default.createElement('i', { className: 'jiangbei' }),
	                    _react2.default.createElement(
	                        'span',
	                        null,
	                        'joinDOTA联赛第3赛季'
	                ...
	                _react2.default.createElement('img', { className: 'fl', src: 'http://picture.show.173.com/artshow/artshow_180001810' }),
	                _react2.default.createElement(
	                    'label',
	                    { className: 'fl live' },
	                    '免费看'
	                ...
	                _react2.default.createElement(
	                    'span',
	                    { className: 'fr' },
	                    'Killing Spree。Killing Spree是长期的战战队争霸活动，参赛队伍是四支来自的战队争霸活动，参赛队伍是四支来自的战队争霸活动，参赛队伍是四支来自支来自北美Killing Spree。Killing Spree是长期的战队争霸活动，参赛队伍是四支来自北美的顶尖战队。每支队伍想要获胜必须Killing Spree。Killing Spree是长期的战队争霸活动，参赛队伍是四支来自北美的顶尖战队。每支队伍想要获胜必须的顶尖战队。每支队伍想要获胜必须一路奋战，连赢三场，达到“大杀特杀（killing spree）”。比赛由NEO Dota主办'
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MatchList = function (_Component) {
	    _inherits(MatchList, _Component);

	    function MatchList() {
	        _classCallCheck(this, MatchList);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(MatchList).call(this));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Match = function (_Component) {
	    ...
	    function Match() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Match).call(this));
	    }
	    ...
	    _createClass(Match, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'span',
	                    { className: 'match-date font400' },
	                    '2012年12月12日12:12'
	                ),
	                _react2.default.createElement('img', { src: './images/secret.png' }),
	                _react2.default.createElement(
	                    'span',
	                    { className: 'team' },
	                    'LGD'
	                ...
	                _react2.default.createElement(
	                    'a',
	                    { className: 'match-vedio',
	                        href: 'http://v.youku.com/v_show/id_XMTU4ODY5OTIyMA==.html?from=y1.7-2' },
	                    _react2.default.createElement(
	                        'span',
	                        null,
	                        '视频'
	                ...
	                _react2.default.createElement(
	                    'a',
	                    { className: 'match-replay', href: 'http://v.youku.com/v_show/id_XMTU4ODY5OTIyMA==.html?from=y1.7-2' },
	                    _react2.default.createElement(
	                        'span',
	                        null,
	                        '下载录像1'
